package co.com.villota.microservice.resolveEnigmaApi.routes;

import org.apache.camel.builder.RouteBuilder;
import org.apache.camel.model.dataformat.JsonLibrary;
import org.springframework.stereotype.Component;

import co.com.villota.microservice.resolveEnigmaApi.model.client.ClientJsonApiBodyResponseSuccess;
...
public class GetStepThreeClientRoute extends RouteBuilder {
    ...
    public void configure() throws Exception {
        ...
        .to("http4://localhost:8094/v1/getOneEnigma/getStep")
